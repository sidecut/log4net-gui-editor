...
[assembly: AssemblyTitle("Log4net Configuration Editor dll")]
#if(DEBUG)
[assembly: AssemblyDescription("It offer an embbed GUI to edit log4net configuration in friendly way.(DEBUG build)")]
#else
[assembly: AssemblyDescription("It offer an embbed GUI to edit log4net configuration in friendly way.(RELEASE build)")]
#endif
