...
#if(DEBUG)
[assembly: AssemblyDescription("This tool can help use to configure log4net easily.(DEBUG build)")]
#else
[assembly: AssemblyDescription("This tool can help use to configure log4net easily.(RELEASE build)")]
#endif
